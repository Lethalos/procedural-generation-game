...
public static class Noise
{
    ...
    public static float[,] GenerateNoiseMap(int mapWidth, int mapHeight, NoiseSettings noiseSettings, Vector2 sampleCenter)
    {
        ...
        System.Random rand = new System.Random(noiseSettings.seed);
        ...
        {
            float offsetX = rand.Next(-100000, 100000) + noiseSettings.offset.x + sampleCenter.x;
            float offsetY = rand.Next(-100000, 100000) - noiseSettings.offset.y - sampleCenter.y;
