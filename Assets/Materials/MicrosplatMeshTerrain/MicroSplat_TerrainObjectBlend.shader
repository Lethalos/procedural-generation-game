...
Shader "MicroSplat_TerrainObjectBlend"
{
   Properties
   {
...
_WorldHeightRange("World Height Range", Vector) = (0, 500, 0, 0)
   ...
   SubShader
   {
            Tags {"RenderPipeline" = "UniversalPipeline"  "RenderType" = "UniversalLitShader" "Queue" = "Transparent+100" "IgnoreProjector" = "False" "SplatCount" = "4"}
